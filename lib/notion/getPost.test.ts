...
describe('getPost', () => {
  ...
  describe('success cases', () => {
    it('returns Ok(null) when slug is null', async () => {
      ...
      const result = await getPost({ slug: null, cache: mockCache })
    ...
    it('returns Ok(null) when slug is empty string', async () => {
      ...
      const result = await getPost({ slug: '', cache: mockCache })
    ...
    it('returns Ok with cached post when available', async () => {
      ...
      const result = await getPost({ slug: 'cached-post', cache: mockCache })
    ...
    it('returns Ok with post from Notion API', async () => {
      ...
      const result = await getPost({ slug: 'test-post', cache: mockCache })
    ...
    it('returns Ok(null) when post not found', async () => {
      ...
      const result = await getPost({ slug: 'nonexistent', cache: mockCache })
    ...
    it('skips cache when skipCache is true', async () => {
      ...
      const result = await getPost({ slug: 'fresh-post', skipCache: true, cache: mockCache })
    ...
    it('includes blocks when includeBlocks is true', async () => {
      ...
      const result = await getPost({ slug: 'post-with-blocks', includeBlocks: true, cache: mockCache })
    ...
    it('includes prev/next navigation when includePrevAndNext is true', async () => {
      ...
      const result = await getPost({ slug: 'middle-post', includePrevAndNext: true, cache: mockCache })
  ...
  describe('error cases', () => {
    it('returns Err when Notion API call fails', async () => {
      ...
      const result = await getPost({ slug: 'failing-post', cache: mockCache })
    ...
    it('returns Err when multiple posts found for slug', async () => {
      ...
      const result = await getPost({ slug: 'duplicate', cache: mockCache })
    ...
    it('returns Err when validation fails', async () => {
      ...
      const result = await getPost({ slug: 'invalid', cache: mockCache })
    ...
    it('returns Err when cache read fails', async () => {
      ...
      const result = await getPost({ slug: 'test', cache: mockCache })
    ...
    it('returns Err when getPosts fails during navigation fetch', async () => {
      ...
      const result = await getPost({ slug: 'test', includePrevAndNext: true, cache: mockCache })
    ...
    it('returns Err when getBlockChildren fails during block fetch', async () => {
      ...
      const result = await getPost({ slug: 'test', includeBlocks: true, cache: mockCache })
