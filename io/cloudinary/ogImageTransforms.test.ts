...
describe('transformCloudinaryForOG', () => {
  it('transforms Cloudinary upload URLs with OG dimensions', () => {
    ...
    expect(result).toBe(
      'https://res.cloudinary.com/ooloth/image/upload/c_fill,w_1200,h_630/v1703127894/mu/u-turn.jpg',
    )
  })
  ...
  it('transforms Cloudinary URLs with existing transformations', () => {
    ...
    const result = transformCloudinaryForOG(input)
    expect(result).toBe(
      'https://res.cloudinary.com/ooloth/image/upload/c_fill,w_1200,h_630/f_auto/v123/mu/photo.jpg',
    )
  })
